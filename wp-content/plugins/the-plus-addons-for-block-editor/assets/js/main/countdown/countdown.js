...
var allCount = document.querySelectorAll('.tp-countdown');
if(allCount){
	allCount.forEach( el => {
...
function styleFlipdown(blockId) {
    var future_unixtime_ms = document.querySelector('.' + blockId + ' .flipdown').dataset.time,
